...
public class BuildingDetailResDto {
    ...
    public static BuildingDetailResDto fromEntity(
            com.ilkan.domain.entity.Building b,
            String typeLabelKor
    ) {
        ...
        if (b.getBuildingImage1() != null && !b.getBuildingImage1().isBlank()) gallery.add(b.getBuildingImage1());
        if (b.getBuildingImage2() != null && !b.getBuildingImage2().isBlank()) gallery.add(b.getBuildingImage2());
        ...
        return BuildingDetailResDto.builder()
                ...
                .images(Images.builder().cover(b.getBuildingImage()).gallery(gallery).build())
